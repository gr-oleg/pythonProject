...
let virtual-env = "C:\Users\olehe\OneDrive\Робочий стіл\Функціональне програмування\pythonProject\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Users\olehe\OneDrive\Робочий стіл\Функціональне програмування\pythonProject\venv\Scripts\deactivate.nu"
